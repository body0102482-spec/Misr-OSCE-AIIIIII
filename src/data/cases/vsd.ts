...
export const vsdCase: Case = {
  id: "vsd-001",
  name: "VSD (Ventricular Septal Defect)",
  specialty: "Cardiology",
  difficulty: "Medium",
  time: "10 mins",
  patient: {
    name: "Ziad Tarek Hegazi",
    age: 19,
    gender: "Male",
    occupation: "Student",
    ...
    vitals: {
      bp: "115/75 mmHg",
      hr: "75 bpm (Regular, normal volume)",
      rr: "16 bpm",
      temp: "37.0 °C",
      oxygen: "98%",
    },
  ...
  history: {
    presentIllness: "Onset of shortness of breath (dyspnea) since birth, presenting with an acute exacerbation and progressive course during infancy. It did not associate with cyanosis but caused severe diaphoresis (sweating) and feeding difficulties. The symptoms increased with exertion and were relieved by rest. This infant-onset dyspnea was last felt actively at 2 years of age, during which the patient was investigated via Echocardiography & ECG and managed medically using Captopril (Capoten) and Lasix (furosemide) with complete symptomatic improvement. Over the last 15 days, developed a new complaint of progressive, acute-onset palpitations described as a regular awareness of heartbeat. These palpitations increase with physical exertion and decrease with rest, with no other cardiopulmonary or systemic symptoms.",
    pastHistory: "No history of rheumatic fever. Had infancy heart failure managed with medication until complete resolution around age 2. No history of diabetes or arterial hypertension.",
    drugHistory: "Takes no active medications currently. Completely stopped Captopril and Lasix at age 2.",
    familyHistory: "Positive consanguinity. No siblings or maternal/paternal relatives suffer from congenital cardiovascular heart defects.",
    socialHistory: "Single, 19-year-old male student born and living in Cairo. Non-smoker and has no medical or lifestyle habits of consequence.",
  },
  examination: {
    inspection: "Chest: Precordial inspection shows a symmetrical chest wall with absolutely no precordial bulge (no bulging of ribs). No surgical chest scars, no abnormal skin pigmentations, and no dilated superficial chest veins.",
    inspectionImage: "/CARDIAC INSPECTION.jpg",
    palpation: "Apex: The apex beat is entirely absent (neither visible nor palpable). Pulsations: Bounding pulsations are palpable over the left parasternal area only. Epigastric area, suprasternal, and aortic areas show absolutely no abnormal pulsations. Thrills: No pelvic or apical, left parasternal, aortic, or pulmonary thrills are palpable on cardiac tactile examination.",
    palpationVideo: "/Cardiac palpation.mp4",
    percussion: "Normal cardiac dullness limits. Lung fields are resonant bilaterally on percussion.",
    auscultation: "Precordium: S1 and S2 sounds are of completely normal intensity, with a normal physiological split of S2. Murmur: A loud, extremely harsh pansystolic (holosystolic) murmur , propagated (radiating) widely all over the precordium, with its maximum intensity (punctum maximum) located over the left parasternal area (3rd and 4th left intercostal spaces). No additional heart sounds (no S3 or S4) are audible.",
    auscultationAudio: "/MR+TR+VSD.mp3",
    specialTests: [
      { name: "Respiration Murmur Test", finding: "Murmur intensity does not increase on inspiration, distinguishing it from Tricuspid Regurgitation (Carvallo's sign is negative)" },
      { name: "Amyl Nitrite Inhalation", finding: "Murmur intensity decreases, distinguishing VSD from Mitral Regurgitation (which also decreases) vs Aortic Stenosis/HCM (which increases)" }
    ],
  },
  investigations: [
    { name: "ECG", result: "Sinus rhythm at 75 bpm. Completely normal cardiac axis, normal P wave duration, and normal QRS voltage criteria with no evidence of left or right ventricular hypertrophy." },
    { name: "Chest X-Ray", result: "Normal cardiac size and contour with a cardiothoracic ratio of 48%. Normal pulmonary hilar vascular markings, completely clear costophrenic and cardiophrenic angles." },
    { name: "Echocardiography", result: "Small perimembranous ventricular septal defect (VSD) measuring 3.5 mm in diameter. Evidence of a high-velocity restrictive left-to-right shunt with a peak gradient (PG) of 72 mmHg. Left ventricle and left atrium are of completely normal dimensions. Normal estimated systolic pulmonary artery pressure (SPAP: 20 mmHg). Excellent overall ventricular function with LVEF: 68%." },
    { name: "CBC / Basic Labs", result: "Hb: 14.2 g/dL, WBC: 5.8 x10^9/L, Platelets: 245,000. Kidneys and liver function parameters are fully within normal ranges." }
  ],
  diagnosis: {
    provisional: "Congenital Small Restrictive Ventricular Septal Defect (Maladie de Roger)",
    differentials: ["Mitral Regurgitation", "Tricuspid Regurgitation", "Aortic Stenosis", "Hypertrophic Obstructive Cardiomyopathy (HOCM)"],
    management: "No active pharmacological management or surgical intervention is indicated at this stage due to the highly restrictive, hemodynamically insignificant nature of the shunt. The patient should be reassured that his life expectancy is fully normal and he can participate in standard active student life. Routine echocardiography follow-up every 2-3 years. Maintain high oral/dental hygiene compliance and practice antibiotic prophylaxis for infective endocarditis prior to high-risk bacteremic dental procedures.",
  },
  checklist: [
    { item: "Elicited childhood history of early infantile dyspnea associated with sweating, feeding difficulty, and resolution by age 2", category: "History" },
    { item: "Asked about current palpitations onset (15 days), progressive course, regular rhythm, and triggers", category: "History" },
    { item: "Ruled out past history of rheumatic fever, and detailed the previous Captopril and Lasix usage", category: "History" },
    { item: "Inspected the precordium carefully to rule out surgical scars, precordial bulge, and dilated veins", category: "Examination" },
    { item: "Palpated the chest, confirming an absent apex beat and documenting left parasternal pulsations", category: "Examination" },
    { item: "Systematically palpated all cardiac areas (apical, left parasternal, aortic, pulmonary) to rule out tactile thrills", category: "Examination" },
    { item: "Auscultated a loud, harsh pansystolic murmur loudest at the left parasternal area that radiates all over the precordium", category: "Examination" },
    { item: "Interpreted the Echocardiography report confirming a small 3.5 mm VSD with restrictive high-velocity (72 mmHg) left-to-right shunt", category: "Reasoning" },
    { item: "Diagnosed the case correctly as a small perimembranous VSD (Maladie de Roger)", category: "Reasoning" },
    { item: "Reassured the student patient about his normal life expectancy while counseling him on endocarditis prophylaxis during dental procedures", category: "Communication" }
  ],
  examinerQuestions: [
    {
      id: "vsd-viva-1",
