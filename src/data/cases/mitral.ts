...
export const mitralCase: Case = {
  ...
  patient: {
    ...
    vitals: {
      bp: "110/70 mmHg",
      hr: "88 bpm (Regular, hyperdynamic)",
      rr: "18 bpm",
      temp: "37.0 °C",
      oxygen: "97%",
    },
  ...
  history: {
    presentIllness: "Symptoms started 5 years ago with gradual onset progressive dyspnea on exertion, which decreases with rest. Hospitalized and diagnosed with rheumatic fever (treated with corticosteroids & aspirin and improved). Redeveloped progressive dyspnea and rapid palpitations two weeks after hospital discharge. Currently sleeps on 2 pillows due to paroxysmal nocturnal dyspnea (PND). Denies cough, hemoptysis, active fever, or recurrent chest infections. Denies any systemic congestion (no lower limb edema, no ascites, no hepatic/GIT congestion) or low cardiac output symptoms (no syncope, no dizziness, no cold extremities). No chest pain, pressure symptoms (hoarseness, dysphagia), or thromboembolic events.",
    pastHistory: "Recurrent tonsillitis 4 times per year treated medically and eventually resolved via tonsillectomy. Six months following the procedure, developed bilateral lower limb edema resulting in admission to Al-Demirdash hospital for symptomatic management.",
    drugHistory: "Currently on Capoten (Captopril), Lasix (furosemide), and prophylactic intramusculer Penicillin.",
    familyHistory: "No consanguinity. No family members suffer from the same cardiac condition.",
    socialHistory: "Single student born and living in Shebein Al-Kanater, Qalyubia. Non-smoker, has no habits of medical significance.",
  },
  examination: {
    inspection: "Chest: Precordial inspection shows moderate Pectus excavatum chest wall depression .there are bilateral pitting edema. Absolutely no surgical scars, no dilated collateral chest veins, no skin pigmentations, and no generalized precordial bulge.",
    inspectionImage: "/Pectus excavatum.jpg, /bilateral_pitting_edema_leg.jpg",
    palpation: "Apex: Not visible, but palpable in the 5th left intercostal space just outside the midclavicular line in the left lateral position. The apex beat is localized and hyperdynamic with no systemic thrill. Left parasternal, aortic, and pulmonary areas show no abnormal pulsations, thrills, or parasternal heave. No epigastric or suprasternal pulsations.",
    palpationVideo: "/Cardiac palpation.mp4",
    percussion: "Normal cardiac dullness borders. Lung fields are resonant to percussion bilaterally.",
    auscultation: "Apex S1: Soft and muffled (due to poor/incomplete valve closure in severe MR). S2: Normal intensity. Murmur: Prominent, blowing pansystolic (holosystolic) murmur, radiating (propagated) to both the left axilla and the western sternal margins. The murmur significantly increases in intensity in the left lateral position and after mild physical exertion. Additional sounds: None audible (though S3 may clinically be expected due to LV volume overload, it is not present here).",
    auscultationAudio: "/MR+TR+VSD.mp3",
    specialTests: [
      { name: "Left Lateral Maneuver", finding: "Murmur intensity increases significantly when patient lies on the left side" },
      { name: "Axillary Radiation Test", finding: "The pansystolic murmur is clearly heard radiating directly into the left axilla" },
      { name: "Exertion Test", finding: "Apical pansystolic blowing murmur increases in severity following brief physical effort" }
    ],
  },
  investigations: [
    { name: "ECG", result: "Sinus rhythm at 88 bpm. Left Atrial Enlargement represented by a broad, notched P wave in lead II (P-mitrale) and Left Ventricular Hypertrophy (LVH) voltage criteria." },
    { name: "Echocardiography", result: "Severe Mitral Regurgitation (MR), substantial regurgitant jet area. Dilated Left Ventricle with high diastolic volumes. Dilated Left Atrium (4.8 cm). Good global hyperdynamic systolic function with Left Ventricular Ejection Fraction (LVEF): 65%." },
    { name: "Chest X-Ray", result: "Cardiomegaly with a prominent left-sided heart border indicating enlargement of the left ventricle and left atrial appendage. Symmetrical pectus excavatum depression of the lower sternum." },
    { name: "CBC / Inflammatory markers", result: "Hb: 13.5 g/dL, WBC: 6.2 x10^9/L, ESR: 10 mm/hr (Normal), CRP: Negative, ASOT: 120 IU." }
  ],
  diagnosis: {
    provisional: "Chronic Rheumatic Severe Mitral Regurgitation managed with medical therapy",
    differentials: ["Mitral Stenosis", "Tricuspid Regurgitation", "Ventricular Septal Defect (VSD)", "Aortic Stenosis", "Dilated Cardiomyopathy"],
    management: "Continue optimization of medical therapy with Captopril (Capoten) for afterload reduction, and Lasix (furosemide) for pulmonary congestion control. Strict compliance with long-term prophylaxis Penicillin. Refer to cardiovascular surgery for mitral valve repair/replacement evaluation given his highly symptomatic class (PND and exertion dyspnea) with severe valvular regurgitation.",
  },
  checklist: [
    { item: "Elicited details of age (18) and residence in Shebein Al-Kanater, Qalyubia", category: "History" },
    { item: "Asked about recurrent childhood tonsillitis, subsequent tonsillectomy, and Al-Demirdash admission", category: "History" },
    { item: "Explored dyspnea characteristics, paroxysmal nocturnal dyspnea (2 pillows), and palpitations", category: "History" },
    { item: "Carefully ruled out low cardiac output, pressure symptoms, and systemic congestion on review of systems", category: "History" },
    { item: "Inspected for chest wall deformities (Pectus excavatum) and ruled out scars or precordial bulge", category: "Examination" },
    { item: "Palpated localized, hyperdynamic apex in the 5th Left ICS outside the MCL in left lateral position", category: "Examination" },
    { item: "Noted absence of palpable thrill at the apex and absence of parasternal heaves", category: "Examination" },
    { item: "Auscultated a muffled/soft S1 sound at the cardiac apex", category: "Examination" },
    { item: "Identified blowing pansystolic murmur propagating to the left axilla which increases on left lateral/exertion", category: "Examination" },
    { item: "Diagnosed Rheumatic Mitral Regurgitation with medical optimization instructions and surgical assessment", category: "Reasoning" },
    { item: "Counseled patient with professional clinical empathy on penicillin compliance", category: "Communication" }
  ],
  examinerQuestions: [
    {
      id: "mr-viva-1",
