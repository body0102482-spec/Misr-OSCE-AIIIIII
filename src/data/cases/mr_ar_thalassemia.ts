...
export const mrarThalassemiaCase: Case = {
  id: "mrar-thal-001",
  name: "MR + AR + Thalassemia Major",
  specialty: "Cardiology",
  difficulty: "Hard",
  time: "15 mins",
  patient: {
    name: "Youssef Ibrahim El-Sharnouby",
    age: 33,
    gender: "Male",
    occupation: "Retired Construction Worker",
    chiefComplaint: "Shortness of breath and awareness of heartbeat (palpitations).",
    vitals: {
      bp: "140/50 mmHg",
      hr: "96 bpm (Regular, bounding hyperdynamic pulse)",
      rr: "20 bpm",
      temp: "37.1 °C",
      oxygen: "94%",
    },
  ...
  history: {
    presentIllness: "Symptoms started 8 years ago of a gradual onset and progressive course. Currently reports shortness of breath (dyspnea) of 2-week duration, which increases with exercise and decreases with rest. Associated with rapid, regular palpitations (awareness of heartbeat). Positive symptoms: Paroxysmal nocturnal dyspnea (PND) when lying flat, causing him to wake up after 2 hours of sleep (requires sleeping on 2 pillows). Scleral jaundice is present. Negative symptoms: No cough, no hemoptysis, no recurrent chest infections, no active fever, no weight loss. No systemic congestion (no lower limb edema, no ascites, no right hypochondrial pain or dyspepsia). No low cardiac output symptoms (no syncope, no headache, no blurring, no dizziness, no oliguria, no cold extremities). No cyanosis, chest pain, pressure signs (hoarseness, dysphagia), or thromboembolic events (hemiplegia, painless hematuria).",
    pastHistory: "Patient had an appendectomy. Crucially, diagnosed with Thalassemia Major in early childhood; underwent a therapeutic Splenectomy due to hypersplenism and severe anemia. Patient receives regular blood transfusions every month. No history of diabetes or hypertension.",
    drugHistory: "Takes Capoten (Captopril), Lasix (furosemide), Desferal (deferoxamine) for iron chelation, and Folic Acid.",
    familyHistory: "Positive consanguinity. No siblings or other family members suffer from a similar condition.",
    socialHistory: "Single, lives with family in Giza. Retired construction worker due to chronic physical illness. Non-smoker, has no habits of medical significance.",
  },
  examination: {
    inspection: "Abdominal inspection: Splenectomy scar (left subcostal region) . Evident upper abdominal swelling/bulge indicating hepatomegaly. Cardiac inspection: . Bounding visible apical, epigastric, and suprasternal pulsations. No visual precordial bulge, dilated venous collaterals, or abnormal chest skin pigmentations.",
    inspectionImage: "/Splenectomy Scar WITH HEPATOMEGLY.jpg, /Jaundice_.jpg",
    palpation: " Cardiac palpation: Apex beat is localized in the Left 5th intercostal space at the midclavicular line (MCL), distinctly hyperdynamic/heaving with absolutely no palpable thrill (Rate, Rhythm, and Rocking/hyperdynamic character are key). Epigastric area and suprasternal notch show bounding pulsations, but no thrills. Aortic, pulmonary, and left parasternal areas reveal no abnormal thrills or heaving.",
    palpationVideo: "/Cardiac palpation.mp4",
    percussion: "Dullness over the enlarged hepatic borders. Lung fields are resonant bilaterally.",
    auscultation: "Cardiac auscultation shows coexisting MR and AR signs: S1: characteristically ACCENTUATED at the apex due to hyperdynamic circulation from chronic thalassemia anemia. Apical pansystolic murmur that is propagated (radiates) to the left axilla and the tricuspid area; increases with exertion and in the left lateral position. S2 at first aortic area is soft/muffled. Soft, blowing decrescendo early diastolic murmur is heard in the 2nd aortic area (left 3rd parasternal line / Erb's point). This murmur is best heard when asking the patient to stop breathing in full expiration while leaning forward.",
    auscultationAudio: "/MR+TR+VSD.mp3, /Aortic Regurgitation- normal speed(MP3_160K).mp3",
    specialTests: [
      { name: "Auscultating early diastolic murmur", finding: "Elicited clearly in the left 3rd parasternal space when the patient stops breathing in deep expiration." },
      { name: "Water-hammer Pulse", finding: "Positive (bounding corrigan pulse due to aortic regurgitation)" },
      { name: "Liver Palpation", finding: "Rt lobe is 4 fingers below costal margin, Lt lobe is 5 fingers below xiphoid process" }
    ],
  },
  investigations: [
    { name: "CBC", result: "Hb: 8.2 g/dL (Severe microcytic hypochromic anemia consistent with Thalassemia Major), WBC: 5.6 x10^9/L, Platelets: 460,000 (Elevated post-splenectomy status)." },
    { name: "Serum Ferritin", result: "3,200 ng/mL (Severely elevated indicating secondary chronic iron overload / risk of cardiac hemochromatosis cardiomyopathy)." },
    { name: "Echocardiography", result: "Severe Mitral Regurgitation (MR) and moderate Aortic Regurgitation (AR). Dilated Left Ventricle with high diastolic volume. Left Ventricular Ejection Fraction (LVEF): 55%. No infective endocarditis vegetations seen." },
    { name: "ECG", result: "Sinus tachycardia, Left Ventricular Hypertrophy (LVH) voltage criteria with high amplitude R waves." }
  ],
  diagnosis: {
    provisional: "Chronic Rheumatic Severe Valvular Heart Disease (Mitral Regurgitation & Aortic Regurgitation) complicated by Thalassemia Major and secondary myocardial iron overload",
    differentials: ["Isolated Mitral Regurgitation", "Isolated Aortic Regurgitation", "Dilated Cardiomyopathy secondary to Hemochromatosis", "Infective Endocarditis on underlying Valvular lesion"],
    management: "Continue Lasix (Furosemide) for pulmonary congestive control and Capoten (Captopril) for afterload reduction. High adherence to Desferal (deferoxamine) iron chelation therapy to protect the myocardium from toxic iron deposits. Regular monthly blood transfusions with pre-transfusion Hb targets around 9.5-10 g/dL. Maintain folic acid. Refer to cardiology/hematology combined committee for cardiac T2* MRI and surgical valve repair/replacement planning.",
  },
  checklist: [
    { item: "Asked about Thalassemia Major childhood history, splenectomy, and monthly transfusion frequency", category: "History" },
    { item: "Explored dyspnea, paroxysmal nocturnal dyspnea details, and regular palpitations", category: "History" },
    { item: "Inquired about jaundice and clarified its source (hemolytic/iron-related anemia rather than cardiac systemic failure)", category: "History" },
    { item: "Inspected for surgical scars (splenectomy left subcostal, appendectomy right iliac over McBurney, paramedian sternotomy)", category: "Examination" },
    { item: "Palpated displaced/bounding apex and abdominal liver margins (Rt lobe 4 fingers, Lt lobe 5 fingers)", category: "Examination" },
    { item: "Auscultated accentuated S1 (anemic state hyperdynamic flow) and apical pansystolic murmur radiating to axilla", category: "Examination" },
    { item: "Auscultated soft blowing decrescendo early diastolic murmur at the left 3rd parasternal space with breath hold", category: "Examination" },
    { item: "Evaluated serum Ferritin, CBC (post-splenectomy thrombocytosis), and Echocardiographic valvular findings", category: "Reasoning" },
    { item: "Linked monthly blood transfusions to potential secondary myocardial hemochromatosis risk", category: "Reasoning" },
    { item: "Exhibited compassionate medical communication for a patient suffering double burden of hematology and cardiology conditions", category: "Communication" }
  ],
  examinerQuestions: [
    {
      id: "mrar-thal-viva-1",
