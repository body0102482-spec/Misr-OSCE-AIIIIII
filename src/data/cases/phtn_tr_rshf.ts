...
export const phtnTrRshfCase: Case = {
  id: "phtn-tr-001",
  name: "P.HTN -> RVE -> Functional TR & RSHF",
  specialty: "Cardiology",
  difficulty: "Hard",
  time: "15 mins",
  patient: {
    name: "Hazem Mamdouh Abdel-Gawad",
    age: 29,
    gender: "Male",
    occupation: "Administrative Clerk",
    chiefComplaint: "Shortness of breath and swelling of both lower limbs for 3 months.",
    vitals: {
      bp: "115/80 mmHg",
      hr: "92 bpm (Regular, average volume)",
      rr: "20 bpm",
      temp: "36.9 °C",
      oxygen: "93% (Room air)",
    },
  ...
  history: {
    presentIllness: "Onset of symptoms started 3 months ago with a gradual onset and progressive course. Complains of progressive dyspnea (shortness of breath) that increases significantly with physical exercise and decreases with rest, with no other association. Associated with a rapid, regular heartbeat (palpitations) and a slow-growing abdominal swelling (ascites) and right upper quadrant heaviness (hepatic congestion). Reports mild yellow discoloration of the eyes (scleral jaundice). Positive symptoms: Bilateral lower limb swelling (pitting edema). Negative symptoms: No cough, no hemoptysis, no recurrent chest infections, and no fever. Crucially, denies orthopnea or paroxysmal nocturnal dyspnea (PND), reflecting isolated right-sided heart failure. Denies syncope, headache, blurring, dizziness, oliguria, cold extremities, or pallor (no low cardiac output symptoms). No chest pain, cyanosis, pressure symptoms (hoarseness, dysphagia), or thromboembolic manifestations.",
    pastHistory: "Patient had a confirmed deep vein thrombosis (DVT) in his left lower limb 3 years ago following a leg fracture, treated with oral anticoagulants for only 3 months. No history of childhood rheumatic fever, asthma, or congenital heart diseases. He is neither diabetic nor hypertensive.",
    drugHistory: "Takes Lasix (furosemide) 40mg once daily and Aldactone (spironolactone) 50mg once daily. Recently started on Sildenafil 20mg three times daily. Takes no other chronic medications.",
    familyHistory: "Negative consanguinity. No siblings or other family members suffer from a similar respiratory or cardiac condition.",
    socialHistory: "Single, 29-year-old male living with his family in Benha, Qalyubia. Works as an administrative clerk (sedentary desk job). Non-smoker, with no habits of medical significance.",
  },
  examination: {
    inspection: "General Examination: Conscious, alert, comfortable sitting flat (no orthopnea). Prominent bilateral pitting lower limb edema extending up to the mid-shins, and congested neck vein . Precordial Inspection: Symmetrical chest wall with absolutely no precordial bulge. No surgical operation or sternotomy scars, no visible dilated collateral chest veins, and no abnormal skin pigmentations.",
    inspectionImage: "/CARDIAC INSPECTION.jpg, /congested neck vein (1).jpg, /bilateral_pitting_edema_leg.jpg",
    palpation: "Apex Beat: Diffuse apex beat located in the Left 5th intercostal space, shifted outwards (laterally) outside the midclavicular line (MCL). On palpation, characters show a normal character (no sustained lifting heave) with absolute absence of palpable thrill. Other Pulsations: Bounding epigastric pulsations are palpable, originating distinctly from the right side towards the left (pulsating liver and right ventricular enlargement). A distinct Left Parasternal heave is present, indicating moderate Right Ventricular Enlargement (RVE). Bounding pulmonary pulsations are palpable over the pulmonary area (Left 2nd intercostal space) indicating severe Pulmonary Hypertension (PHTN). No aortic pulsations are detected. Thrills: Absolute absence of tactile thrills over the apical, left parasternal, aortic, or pulmonary areas on careful cardiac tactile examination.",
    palpationVideo: "/Cardiac palpation.mp4",
    percussion: "Lungs: Bilaterally resonant lung fields, with no signs of pleural effusion. Heart: Shifted cardiac dullness border to the right side of the sternal border indicating right-sided chamber enlargement.",
    auscultation: "Tricuspid Area (Functional Tricuspid Regurgitation - TR): A loud pansystolic murmur is heard loudest over the tricuspid area (4th left parasternal space), which characteristically increases in intensity during deep inspiration (positive Carvallo's sign). This murmur radiates/propagates widely towards both the cardiac apex and the base of the heart. Pulmonary Area (Pulmonary Hypertension): S1 is normal, but S2 is distinctly ACCENTUATED over the pulmonary area (left 2nd intercostal space) due to high-pressure closing of the pulmonary valve. No diastolic murmurs, opening snaps, or gallops are audible.",
    auscultationAudio: "/MR+TR+VSD.mp3",
    specialTests: [
      { name: "Carvallo's Sign", finding: "Positive (the tricuspid pansystolic murmur increases in intensity during deep inspiration due to increased venous return to the right heart)" },
      { name: "Hepatojugular Reflux", finding: "Positive (applying sustained pressure over the liver causes a persistent elevation of the Jugular Venous Pressure JVP for >15 seconds)" },
    ],
  },
  investigations: [
    { name: "ECG", result: "Sinus rhythm at 92 bpm. Right axis deviation (+120 degrees). Evidence of Right Ventricular Hypertrophy (RVH) with a tall R wave in V1 (>7mm) and deep S wave in V6, accompanied by T-wave inversions in V1-V3 (RV strain). Right Atrial Enlargement (P-pulmonale) with a tall, peaked P wave (>2.5mm) in lead II." },
    { name: "Echocardiography", result: "Severe Pulmonary Hypertension with estimated systolic pulmonary artery pressure (SPAP) of 78 mmHg. Severe Right Ventricle (RV) and Right Atrium (RA) dilation with flattening of the interventricular septum (D-shaped LV in short axis). Severe functional Tricuspid Regurgitation (TR) with structurally normal leaflets, arising from tricuspid annular dilation secondary to RV enlargement. Left ventricle has normal size, geometry, and preserved systolic function (LVEF: 62%). No intracardiac shunts." },
    { name: "CT Pulmonary Angiography (CTPA)", result: "Evidence of chronic organized, eccentric thrombi adhering to the walls of the lobar and segmental pulmonary arteries bilaterally, consistent with Chronic Thromboembolic Pulmonary Hypertension (CTEPH). Bulging of the main pulmonary artery stem (diameter 34 mm)." },
    { name: "CBC / Basic Labs", result: "Hb: 15.0 g/dL, WBC: 6.5 x10^9/L, Platelets: 230,000. Total Bilirubin: 2.1 mg/dL (Mildly elevated, indirect fraction predominant due to hemolytic/congestive jaundice), ALT/AST: 48/52 U/L (Mild hepatic congestion elevation), Serum Creatinine: 1.0 mg/dL." }
  ],
  diagnosis: {
    provisional: "Chronic Thromboembolic Pulmonary Hypertension (CTEPH) leading to Right Ventricular Enlargement, Functional Severe Tricuspid Regurgitation, and Right-Sided Heart Failure",
    differentials: ["Primary Idiopathic Pulmonary Arterial Hypertension (IPAH)", "Rheumatic Heart Disease with organic Tricuspid Regurgitation", "Left-sided heart failure with secondary pulmonary hypertension", "Ebstein's Anomaly"],
    management: "Re-initiate long-term therapeutic anticoagulation (e.g., Warfarin target INR 2.0-3.0) to prevent recurrent thromboembolism in CTEPH. Optimize diuretic therapy with Lasix (furosemide) and Aldactone (spironolactone) to relieve lower limb edema and hepatic congestion. Refer to a specialized pulmonary hypertension center for evaluation of pulmonary thromboendarterectomy (PTE) or balloon pulmonary angioplasty (BPA). Continue pulmonary vasoactive therapies (Sildenafil) and monitor renal function and electrolytes regularly.",
  },
  checklist: [
    { item: "Elicited details of prior deep vein thrombosis (DVT) 3 years ago following fracture and improper therapy duration", category: "History" },
    { item: "Explored exertional dyspnea, abdominal swelling/heaviness, and regular rapid palpitations", category: "History" },
    { item: "Identified key negative symptoms, confirming the absence of left-sided heart failure signs (no orthopnea or PND)", category: "History" },
    { item: "Documented the presence of bilateral lower limb pitting edema and mild scleral jaundice on general examination", category: "Examination" },
    { item: "Palpated a diffuse shifted cardiac apex in the Left 5th ICS outside the midclavicular line", category: "Examination" },
    { item: "Detected diagnostic pulsations (epigastric, Left parasternal heave for RVE, and pulmonary area pulsations for PHTN)", category: "Examination" },
    { item: "Auscultated a loud pansystolic murmur at the tricuspid area propagating to the apex/base", category: "Examination" },
    { item: "Confirmed positive Carvallo's sign (murmur louder on inspiration) and accentuated S2 or P2 over pulmonary area", category: "Examination" },
    { item: "Interpreted investigations including ECG showing RVH and P-pulmonale, and Echocardiography outlining SPAP of 78 mmHg", category: "Reasoning" },
    { item: "Formulated diagnosis linking previous DVT to Chronic Thromboembolic Pulmonary Hypertension (CTEPH) and right-sided heart failure", category: "Reasoning" },
    { item: "Counseled patient with empathy regarding long-term therapeutic anticoagulation compliance and advanced surgical options (PTE)", category: "Communication" }
  ],
  examinerQuestions: [
    {
      id: "phtn-viva-1",
