...
export const fibrosisShoemakerCase: Case = {
  id: "fibrosis-002",
  name: "Lung Fibrosis & Volume Loss (Post-TB / Shoemaker)",
  specialty: "Respiratory",
  difficulty: "Hard",
  time: "15 mins",
  patient: {
    name: "Adel Mourad El-Gendy",
    age: 52,
    gender: "Male",
    occupation: "Shoemaker",
    chiefComplaint: "Cough with sputum production of 1-month duration.",
    vitals: {
      bp: "120/80 mmHg",
      hr: "84 bpm (Regular)",
      rr: "20 bpm (Limited on right side)",
      temp: "36.7 °C",
      oxygen: "95% (On room air)",
    },
  },
  history: {
    presentIllness: "The patient is a 52-year-old shoemaker who presents with a productive cough of 1-month duration. The cough is gradual in onset and progressive in course, producing about 3-4 tablespoons of yellowish-white, sticky, odorless sputum daily, particularly in the mornings. He reports a long-term, non-progressive baseline exertional breathlessness that has been present since he completed treatment for pulmonary tuberculosis 15 years ago, but denies any recent acute worsening of dyspnea at rest. Positive symptoms: Chronic cough with morning sputum expectoration. Negative symptoms: No active fever, no night sweats, no chronic weight loss or anorexia (ruling out active TB relapse). No hemoptysis, no chest pain, and no history of recurrent sputum purulence since his TB treatment. No systemic congestion (no lower limb edema, no right hypochondrial pain, no jaundice), no orthopnea, and no paroxysmal nocturnal dyspnea (PND). No low cardiac output symptoms (no syncope, no headache, no dizziness, or cold extremities) and no cyanosis.",
    pastHistory: "Had severe Pulmonary Tuberculosis (TB) 15 years ago in his right lung, which was fully treated with a standard 6-month regimen of anti-TB drugs. He did not undergo any thoracic surgical intervention (lobectomy, decortication, or drainage), meaning his recovery was entirely medical. No past history of diabetes mellitus, arterial hypertension, bronchial asthma, or rheumatic carditis.",
    drugHistory: "Takes no daily chronic medications. Uses paracetamol occasionally for headache or chest soreness.",
    familyHistory: "Negative consanguinity. No siblings or first-degree relatives suffer from chronic lung disease, emphysema, or early-onset genetic/cardiac conditions.",
    socialHistory: "Married with 3 children. Worked as a custom shoemaker for over 30 years in El-Darb El-Ahmar, Cairo, with heavy, daily, long-term exposure to organic solvents, chemical adhesives (such as contact cement/glue), leather dust, and poorly ventilated workshop fumes. He is an ex-smoker who used to smoke 15 cigarettes a day for 25 years but quit permanently 15 years ago upon his TB diagnosis.",
  },
  examination: {
    inspection: "Chest Inspection shows: Pectus excavatum (funnel chest deformity) presenting as a distinct depression in the lower sternal region. Asymmetrical chest wall shape with a prominent unilateral right-sided retraction (volume loss of the right hemithorax). Symmetrical but restricted chest wall movement on the right side (limited respiratory excursion). Respiration style is abdominothoracic (normal for adult males). Positive Trail's Sign is visible (marked prominence of the sternal head of the right sternocleidomastoid muscle due to tracheal deviation to the right ). Pulsations: Absent apical pulsation (due to shift of the cardiac silhouette away from the left chest wall) and visible epigastric pulsation. There are absolutely no surgical scars (confirming no lobectomy/thoracotomy), no skin pigmentations, and no dilated collateral chest wall veins.",
    inspectionImage: "/Pectus excavatum.jpg, /trachea shift ( trill's sign ).jpg",
    palpation: "Tracheal Palpation: Confirming that the trachea is significantly shifted (pulled) to the right side (ipsilateral traction indicating right-sided volume loss and fibrosis). Tactile Vocal Fremitus (TVF): Distinctly increased TVF over the right supramammary area (typical of lung consolidation/fibrosis under a patent bronchus), but no tenderness and no palpable wheezes. Unilateral, marked limitation of chest wall expansion on the right side during deep inspiration.",
    palpationVideo: "/chest palpation.mp4",
    percussion: "Chest Percussion: Heterogeneous right-sided dullness is elicited (corresponding to the underlying lung fibrosis). Left-sided hyperinflation (compensatory emphysema) is present, as evidenced by resonant chest notes. Kronig's Isthmus: Dullness is elicited on the left side of the shoulder band (Kronig's isthmus), whereas the right side is resonant. Bare area of cardiac dullness is dull. Traub's (Traube's) space percussion shows completely normal tympanic resonance.",
    percussionVideo: "/chest percussion.mp4",
    auscultation: "Auscultation of the lungs reveals: Symmetrically diminished air entry over the right side, especially over the right inframammary region. Right-side breath sounds show bronchial breathing in the right supramammary area (classic for upper lobe fibrosis with patent airways), accompanied by fine inspiratory crepitations (crackles) over the right side. Left-side breath sounds show harsh vesicular breathing associated with a prolonged expiratory phase, consistent with compensatory hyperinflation (emphysema). Left-side additional sounds: Generalized, expiratory, polyphonic wheezes are heard on the left side, which change with coughing (consistent with shoemaker-related industrial chronic bronchitis or small airway obstruction).",
    auscultationAudio: "/Fine Crackles Lung Sounds - EMTprep.com(MP3_160K)(2) - Copy.mp3",
    specialTests: [
      { name: "Trail's (Thrill's) Sign Demonstration", finding: "Positive. The sternal head of the right sternocleidomastoid muscle is visually prominent because the trachea is deviated towards the right side.", video: "/treacheal examination.mp4" },
      { name: "Kronig's Isthmus Percussion", finding: "Dullness over the left Kronig's isthmus (normally resonant shoulder strap band, 4-6 cm wide) and resonance over the right." },
      { name: "Traube's Space Percussion", finding: "Normal tympanic resonance is elicited in Traub's space, ruling out splenomegaly or active massive left pleural effusion." }
    ],
  },
  investigations: [
    { name: "Spirometry", result: "FEV1/FVC: 0.82 (Normal/high ratio globally, ruling out active generalized obstruction in the right lung despite localized wheezes on the left side). FVC: 52% of predicted value (Restrictive defect on the right). Total Lung Capacity (TLC): 55% indicating severe parenchymal restriction on the right side." },
    { name: "Chest X-Ray", result: "Marked deviation of the trachea, mediastinum, and cardiac silhouette to the right side. Significant elevation of the right hemidiaphragm with narrowing of the right intercostal spaces (volume loss). Dense, coarse fibrotic bands with pleural thickening are visible in the right apex, with no surgical chest clips or resection lines (unoperated post-TB fibrosis). Pectus excavatum deformity. Left lung field is hyperinflated (compensatory emphysema) with increased radiolucency and some peripheral bronchial wall thickening." },
    { name: "AFB Sputum Smear & PCR", result: "Three consecutive morning sputum smears are fully Negative for Acid-Fast Bacilli (AFB). GeneXpert MTB/RIF PCR: Negative for Mycobacterium tuberculosis DNA (confirming inactive, cured post-tuberculosis pulmonary sequelae)." },
    { name: "Echocardiography", result: "Normal left ventricular dimensions and contractility (LVEF: 62%). Normal right atrial and ventricular dimensions with an estimated systolic pulmonary artery pressure (SPAP) of 30 mmHg." }
  ],
  diagnosis: {
    provisional: "Unilateral Right Lung Fibrosis and Volume Loss secondary to cured Pulmonary Tuberculosis (non-surgical state), Pectus Excavatum, and Industrial Shoemaker-related Chronic Bronchitis in the Left Lung",
    differentials: ["Active Recurrent Pulmonary Tuberculosis", "Chronic Right-sided Fibrothorax/Pleural Thickening", "Unilateral Bronchiectasis", "Lung Cancer with secondary collapse"],
    management: "No active anti-tuberculosis therapy is indicated (cured). Advise strict occupational hygiene, including wearing an industrial safety respirator/mask in the shoemaking workshop to avoid organic solvent, adhesive glues, and leather dust exposure. Treat left-sided bronchitic wheezes with an as-needed inhaled bronchodilator. Counsel the patient on annual pneumococcal and seasonal influenza vaccinations to protect remaining lung capacity. Regular spirometry monitoring and strictly maintain smoking cessation.",
  },
  checklist: [
    { item: "Elicited details of previous pulmonary tuberculosis (15 years ago) and cured medically without thoracotomy or lobectomy", category: "History" },
    { item: "Inquired about a productive cough of 1-month duration accompanied by morning yellowish-white sputum, with no acute rest dyspnea", category: "History" },
    { item: "Asked about shoemaker occupational hazards, including daily exposure to organic solvents, adhesives, and leather dust", category: "History" },
    { item: "Systematically ruled out constitutional and active infectious symptoms (no fever, night sweats, weight loss) to exclude active TB relapse", category: "History" },
    { item: "Inspected the chest carefully, noting right-sided retraction, pectus excavatum deformity, and absence of surgical scars", category: "Examination" },
    { item: "Documented respiratory rate and limited chest movement on the right side, along with positive Trail's (Thrill's) sign", category: "Examination" },
    { item: "Identified absent apical chest pulsation and visible epigastric physical pulsation on inspection", category: "Examination" },
    { item: "Palpated tracheal shift to the right side and noted increased TVF in the right supramammary region with no tenderness", category: "Examination" },
    { item: "Elicited right-sided dullness, left-sided hyperinflation, dullness over the left Kronig's isthmus, and dull cardiac bare area", category: "Examination" },
    { item: "Auscultated diminished air entry on the right side, especially right inframammary, and bronchial breathing in the right supramammary region", category: "Examination" },
    { item: "Detected bilateral additional chest sounds: fine inspiratory crepitations on the right and generalized expiratory polyphonic wheezes on the left modifying with cough", category: "Examination" },
    { item: "Interpreted investigations including restrictive spirometry pattern (FVC 52%) and CXR showing right-sided fibrosis and volume loss without surgical clips", category: "Reasoning" },
    { item: "Formulated diagnosis linking previous TB, Pectus Excavatum, and shoemaker workshop exposures to current chest signs", category: "Reasoning" },
    { item: "Counseled on respirator/mask usage in shoemaking, avoidance of toxic solvents, and annual vaccinations with clinical empathy", category: "Communication" }
  ],
  examinerQuestions: [
